...
### Optimierung des neuronalen Netztes
...
load("synthpop_allData_dummy.Rda")
...
### Evaluationsergebnis für den Zeitraum vom 09.06. - 30.07.2019
...
paste0(content(r, "parsed", "application/json", show_col_types = FALSE))
```
